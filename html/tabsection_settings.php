...
<div class="complete-wrap">
	...
	<form id="js-afrsettings" action="javascript:void(0);" name="afrsettings" method="post">
        ...
        <fieldset class="wpswcafr_fieldset">
    ...
    <tr class="form-field form-required">
        ...
        <fieldset class="wpswcafr_fieldset">
            <legend>Exit Intent Popup</legend>
            <p>
                After enabling ExitIntent popup it monitors visitor mouse movements and detects when a user is likely to leave the website without purchase after adding a product into cart. It shows the popup as with below settings.
            </p>
            <table class="form-table">
                <tbody>
                <tr class="form-field form-required">
